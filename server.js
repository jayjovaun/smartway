...
Create a detailed, structured study pack. Respond with ONLY valid JSON in this exact format:
{
  ...
  "quiz": [
    ...
    try {
        ...
        const generatedText = (_e = (_d = (_c = (_b = (_a = data.candidates) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.content) === null || _c === void 0 ? void 0 : _c.parts) === null || _d === void 0 ? void 0 : _d[0]) === null || _e === void 0 ? void 0 : _e.text;
        if (!generatedText) {
